            ...
            <div class="col-xl-4 col-md-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 mx-auto auth-logo mb-4">
                            ...
                            <a href="{{url('')}}/index.html" class="logo-light">
                                <span><img src="{{url('')}}/assets/images/logo-light.png" alt="" height="22"></span>
                            </a>
                        </div>
                        ...
                        <form action="{{ route('manager.login') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                <a href="{{url('')}}/pages-recoverpw.html" class="text-muted float-end"><small></small></a>
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="btn btn-primary w-100" type="submit"> Manager Log In </button>
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50"> <a href="{{url('')}}/pages-register.html" class="text-white-50 ms-1">Forgot your password?</a></p>
                        <p class="text-white-50">Don't have an account? <a href="{{url('')}}/pages-register.html" class="text-white font-weight-medium ms-1">Sign Up</a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
