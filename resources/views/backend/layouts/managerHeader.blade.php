                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    ...
                                                    <small class="noti-item-subtitle text-muted">Caleb Flakelar commented on Manager</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-1">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <h5 class="noti-item-title fw-semibold font-size-14">Manager <small class="fw-normal text-muted ms-1">1 hours ago</small></h5>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    ...
                                                    <small class="noti-item-subtitle text-muted">Wow ! this Manager looks good and awesome design</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
