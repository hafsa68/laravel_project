                ...
                <div class="py-3 py-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <h4 class="page-title mb-0">product List <span class="float-end"><a href="{{url('category/create')}}" class="btn btn-primary">Add Product</a></span></h4>
                        </div>
                        <div class="col-lg-6">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('product.edit',$item->id)}}" class="btn btn-light">Edit</a>
