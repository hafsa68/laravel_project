           ...
           <!-- slider-area -->
            <section id="home" class="slider-area fix p-relative">
                ...
                <div class="slider-info">                   
                    <div class="social">
                        <span>
                            <a href="{{url('')}}/assets/frontend/#" title="Facebook"><i class="fab fa-facebook-f"></i></a>
                            <a href="{{url('')}}/assets/frontend/#" title="LinkedIn"><i class="fab fa-linkedin-in"></i></a>               
                            <a href="{{url('')}}/assets/frontend/#" title="Twitter"><i class="fab fa-twitter"></i></a>
                            <a href="{{url('')}}/assets/frontend/#" title="Twitter"><i class="fab fa-youtube"></i></a>
                       </span>                    
                                    ...
                                    <div class="slider-content s-slider-content mt-80 text-center">
                                         ...
                                         <h2 data-animation="fadeInUp" data-delay=".4s">Enjoy A Luxury <span>Experience</span> </h2>                                        
                                          <div class="slider-btn mt-30 mb-105">     
                                             <a href="{{url('')}}/assets/frontend/contact.html" class="btn ss-btn active mr-15" data-animation="fadeInLeft" data-delay=".4s">book a seat </a>
                                        </div> 
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="row">
                                ...
                                <div class="services-08-item mb-70">                                    
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html"> Restaurants</a></h3>
                               ...
                               <div class="services-08-item mb-70">                                                 
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html">Luxury Room</a></h3>
                                       <p>Visitors to your city need to eat. In fact, some people visit new towns specifically for the food. Use your insider</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                               <div class="services-08-item mb-70">                                        
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html">Entertainment</a></h3>
                                      <p>Visitors to your city need to eat. In fact, some people visit new towns specifically for the food. Use your insider</p>
                                    </div>
                                </div>
                            </div>
                          <div class="col-lg-6 col-md-6">
                             <div class="services-08-item mb-70">                        
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html">Pool Area</a></h3>
                                        <p>Visitors to your city need to eat. In fact, some people visit new towns specifically for the food. Use your insider</p>
                                    </div>
                                </div>
                            </div>
                              <div class="col-lg-6 col-md-6">
                                  <div class="services-08-item mb-70">                           
                                   ...
                                   <img src="{{url('')}}/assets/frontend/img/icon/fe-icon05.png" alt="img">
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html">Cocktail Bar</a></h3>
                                       <p>Visitors to your city need to eat. In fact, some people visit new towns specifically for the food. Use your insider</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-6 col-md-6">
                               <div class="services-08-item mb-70">                        
                                    ...
                                    <div class="services-08-content">
                                        <h3><a href="{{url('')}}/assets/frontend/single-service.html">Tour Guide</a></h3>
                                        <p>Visitors to your city need to eat. In fact, some people visit new towns specifically for the food. Use your insider</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row justify-content-center align-items-center">
                         <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="s-about-img p-relative  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <a href="{{url('')}}/assets/frontend/https://www.youtube.com/watch?v=gyGsPlt06bo" class="popup-video"> <img src="{{url('')}}/assets/frontend/img/features/about.jpg" alt="img">   </a>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-9">    
                            <div class="section-title center-align mb-80 text-center">
                                <div class="icon mb-50"> <img src="{{url('')}}/assets/frontend/img/icon/hotel-icon-sub.png" alt="img">   </div>
                                ...
                                <div class="mt-30">     
                                             <a href="{{url('')}}/assets/frontend/contact.html" class="btn ss-btn mr-15">Rooms </a>
                                             <a href="{{url('')}}/assets/frontend/contact.html" class="btn active mr-15">suites </a>
                                        </div>
                            </div>
                        </div>
                    </div>
                    <div class="row services-active">
                        <div class="col-xl-4 col-md-6">
                            <div class="single-services text-center mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="{{url('')}}/assets/frontend/img/gallery/room-img01.png">
                                    <img src="{{url('')}}/assets/frontend/img/gallery/room-img01.png" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                     
                                    <h4><a href="{{url('')}}/assets/frontend/single-rooms.html">Minimal Duplex Room</a></h4>    
                                    <p>Visitors to your city need to eat. In fact, some people visit new towns specifically.</p>
                                    <div class="icon">
                                        <ul>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon1.png" alt="img"></li>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon2.png" alt="img"></li>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon3.png" alt="img"></li>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon4.png" alt="img"></li>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon5.png" alt="img"></li>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon6.png" alt="img"></li>
                                        </ul>
                                    </div>
                                    <div class="day-book">
                                        <ul>
                                            <li>$600/Night</li>
                                            <li><a href="{{url('')}}/assets/frontend/contact.html">Book Now</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                             <div class="single-services text-center mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="{{url('')}}/assets/frontend/img/gallery/room-img02.png">
                                    <img src="{{url('')}}/assets/frontend/img/gallery/room-img02.png" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                     
                                    <h4><a href="{{url('')}}/assets/frontend/single-rooms.html">Superior Double Room</a></h4>    
                                    <p>Visitors to your city need to eat. In fact, some people visit new towns specifically.</p>
                                    <div class="icon">
                                        <ul>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon1.png" alt="img"></li>
                        ...
                        <div class="col-xl-4 col-md-6">
                              <div class="single-services text-center mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="{{url('')}}/assets/frontend/img/gallery/room-img03.png">
                                    <img src="{{url('')}}/assets/frontend/img/gallery/room-img03.png" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                    
                                    <h4><a href="{{url('')}}/assets/frontend/single-rooms.html">Super Balcony Double Room</a></h4>    
                                   <p>Visitors to your city need to eat. In fact, some people visit new towns specifically.</p>
                                    <div class="icon">
                                        <ul>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon1.png" alt="img"></li>
                        ...
                        <div class="col-xl-4 col-md-6">
                              <div class="single-services text-center mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="{{url('')}}/assets/frontend/img/gallery/room-img04.png">
                                    <img src="{{url('')}}/assets/frontend/img/gallery/room-img04.png" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                  
                                    <h4><a href="{{url('')}}/assets/frontend/single-rooms.html">Delux Double Room</a></h4>    
                                  <p>Visitors to your city need to eat. In fact, some people visit new towns specifically.</p>
                                    <div class="icon">
                                        <ul>
                                            <li><img src="{{url('')}}/assets/frontend/img/icon/sve-icon1.png" alt="img"></li>
                        ...
                        <div class="col-lg-4 col-md-6">
                             <div class="pricing-box pricing-box2 mb-60">
                                    ...
                                    <div class="pricing-btn">
                                       <a href="{{url('')}}/assets/frontend/contact.html" class="btn active">purchase now</a>
                                    </div>
                                </div>
                         ...
                         <div class="col-lg-12 col-md-12">
                             <div class="service-link">   
                                   <ul>
                                        <li>
                                            <div class="s-link">
                                                 <div class="text"><a href="{{url('')}}/assets/frontend/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Cafe & Wine Bar</h3> <span>Start from <b>$150</b></span></a></div>
                                                    <div class="layer img-hover"><img src="{{url('')}}/assets/frontend/img/bg/sr-img-01.png" alt="shape"></div>
                                            </div>
                                           
                                        </li>  
                                       <li>
                                            <div class="s-link active">
                                           <div class="text"> <a href="{{url('')}}/assets/frontend/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Spa & Wellness</h3> <span>Start from <b>$100</b></span></a></div>
                                            <div class="layer img-hover"><img src="{{url('')}}/assets/frontend/img/bg/sr-img-02.png" alt="shape"></div>
                                           </div>
                                        </li>  
                                       <li>
                                           <div class="s-link">
                                               <div class="text"> <a href="{{url('')}}/assets/frontend/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Restaurant</h3> <span>Start from <b>$130</b></span></a></div>
                                               <div class="layer img-hover"><img src="{{url('')}}/assets/frontend/img/bg/sr-img-03.png" alt="shape"></div>
                                           </div>
                                        </li>  
                                      <li>
                                          <div class="s-link">
                                               <div class="text"><a href="{{url('')}}/assets/frontend/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Meetings & Events</h3> <span>Start from <b>$140</b></span></a></div>
                                               <div class="layer img-hover"><img src="{{url('')}}/assets/frontend/img/bg/sr-img-04.png" alt="shape"></div>
                                          </div>
                                        </li>  
                                   </ul>
                            </div>
                     ...
                     <div class="row">
                        <div class="col-lg-2 col-sm-6">
                            <div class="instagram-box">
                                ...
                                <div class="hover"><a href="{{url('')}}/assets/frontend/#"><img src="{{url('')}}/assets/frontend/img/icon/instagram-icon.png" alt="img"></a></div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6">
                            <div class="instagram-box">
                       ...
                       <div class="col-lg-4 col-md-6">
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{url('')}}/assets/frontend/blog-details.html"><img src="{{url('')}}/assets/frontend/img/blog/inner_b1.jpg" alt="img"></a>
                                </div>                    
                                <div class="blog-content2">                                     
                                    ...
                                    <h4><a href="{{url('')}}/assets/frontend/blog-details.html">Cras accumsan nulla nec lacus ultricies placerat.</a></h4>                                    
                                    <div class="blog-btn"><a href="{{url('')}}/assets/frontend/blog-details.html">Read More</a></div>
                         ...
                         <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{url('')}}/assets/frontend/blog-details.html"><img src="{{url('')}}/assets/frontend/img/blog/inner_b2.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content2">                                    
                                    <div class="date-home">
                                       24th March 2024
                                    ...
                                    <h4><a href="{{url('')}}/assets/frontend/blog-details.html">Dras accumsan nulla nec lacus ultricies placerat.</a></h4>                                   
                                    <div class="blog-btn"><a href="{{url('')}}/assets/frontend/blog-details.html">Read More</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{url('')}}/assets/frontend/blog-details.html"><img src="{{url('')}}/assets/frontend/img/blog/inner_b3.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content2">                                    
                                    <div class="date-home">
                                        24th March 2024
                                    ...
                                    <h4><a href="{{url('')}}/assets/frontend/blog-details.html">Seas accumsan nulla nec lacus ultricies placerat.</a></h4>                                    
                                    <div class="blog-btn"><a href="{{url('')}}/assets/frontend/blog-details.html">Read More</a></div>
                                </div>
                            </div>
                        </div>
